...
export class ProductView {
  //!Hiện sản phẩm hot
  async productHot(san_pham: ProductModel[], tagname: string) {
    let str = "";
  ...
  async productPopular(san_pham: ProductModel[], tagname: string) {
    let str = "";
    san_pham.forEach((sp) => (str += hien1sp(sp)));
    let content = document.querySelector("nav " + tagname) as HTMLElement;
  ...
  async productByCategory(san_pham: ProductModel[], tagname: string) {
    let str = ``;
    san_pham.forEach((sp) => (str += hien1sp(sp)));
    let content = document.querySelector(
      "nav .container .main .products " + tagname
    ) as HTMLElement;
  ...
  async productByKind(san_pham: ProductModel[], tagname: string) {
  ...
  //!Chi tiết sản phẩm
  async productDetail(san_pham: ThuocTinhModel, tagname: string) {
    /* Sim */
    let sim = "";
    if (san_pham.Sim == "") {
      sim += ``;
  ...
  productAD(san_pham: ProductModel[], tagname: string) {
    let str = ``;
    san_pham.forEach((sp) => {
      str += tbody_table(sp);
    });
  ...
  addProductAD(
    ...
    const closeDs_Sp = document.getElementById("ds_sanpham") as HTMLElement;
    ...
    btnAdd.addEventListener("click", (event) => {
      ...
      let id = (document.getElementById("id_sp") as HTMLInputElement).value;
      let id_danh_muc = (
        document.getElementById("danh_muc_select") as HTMLSelectElement
      ).value;
      let id_loai = (
        document.getElementById("loai_select") as HTMLSelectElement
      ).value;
      let ten_sp = (document.getElementById("ten_sp") as HTMLInputElement)
        .value;
      let gia_sp = (document.getElementById("gia_sp") as HTMLInputElement)
        .value;
      let giam_gia = (document.getElementById("giam_gia") as HTMLInputElement)
        .value;
      let hinh = (document.getElementById("hinh") as HTMLInputElement).value;
      let ngay = (document.getElementById("ngay") as HTMLInputElement).value;
      let mau_sac = (document.getElementById("mau_sac") as HTMLInputElement)
        .value;
      let xem = (document.getElementById("xem") as HTMLInputElement).value;
      let hot = (document.getElementById("hot_select") as HTMLInputElement)
        .value;
      let an_hien = (document.getElementById("anhien") as HTMLInputElement)
        .value;
  ...
  //!Check Form
  validateForm_SP = (data: ProductModel) => {
    let isValid = true;
    if (!data.Id) {
  ...
  displayError_SP = (elementId: string, message: string) => {
  ...
  //! Xu ly an thong bao
  clearError_SP = (elementId: string) => {
    const errorElement = document.querySelector(
      `.${elementId}-error`
    ) as HTMLElement;
    if (errorElement) {

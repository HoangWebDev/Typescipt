export default function slideShow() {
  let event = document.querySelector("#event") as HTMLElement;
  let content = `
        <div class="box-event">
          <img
            id="myImg"
...
window.addEventListener("load", () => {
  let nextBtn = document.querySelector(".next") as HTMLElement;
  nextBtn.addEventListener("click", nextImg);

  let prevBtn = document.querySelector(".prev") as HTMLElement;
  ...
  function nextImg() {
    ...
    let imagesSlide = document.querySelector("#myImg") as HTMLImageElement;
  ...
  /* -------------Set/Clear Interval ---------------- */
  var stop = document.querySelector(".box-event") as HTMLElement;
